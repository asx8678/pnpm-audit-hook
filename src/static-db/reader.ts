...
class StaticDbReaderImpl implements StaticDbReader {
  ...
  /**
   * Legacy shard path from before path alignment (flat packages/ dir with
   * slash → double-underscore encoding). Kept for backward compatibility
   * with databases generated by older versions of the update script.
